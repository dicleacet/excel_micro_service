...
if DEBUG:
    ALLOWED_HOSTS = ['127.0.0.1', 'api.istar.com']
    CORS_ALLOW_ALL_ORIGINS = True
    CORS_ALLOWED_ORIGINS = ('http://localhost:3000', 'http://localhost:8080', 'https://istar.com')
else:
    ALLOWED_HOSTS = ['127.0.0.1', 'api.istar.com']
    ...
    CORS_ALLOWED_ORIGINS = ('https://istar.com',)
